...
//		Home.content.add(panelsBuilder.getScrollPane(), BorderLayout.WEST);
    ...
    public void aboutUs() {
        ...
        txt.setText("<html><h2 style=' background-color: blue;'>Hello my name is Boaz and im the founder of eddosql"
                + "my goal in this app is to help engineer simplify they task using mysql"
                + "THis software has a lot to show so stay tuned"
                + "<br>my goal in this app is to help engineer simplify they task using mysql"
                + "THis software has a lot to show so stay tuned"
                + "my goal in this app is to help engineer simplify they task using mysql"
                + "THis software has a lot to show so stay tuned"
                + "my goal in this app is to help engineer simplify they task using mysql"
                ...
                + "THis software has a lot to show so stay tuned"
                + "my goal in this app is to help engineer simplify they task using mysql"
                + "THis software has a lot to show so stay tuned" + "</html></h2>");
        centerPanel.add(txt);
...
//			sqlConnector();
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        e.getComponent().setFont(new Font("sanserif", Font.BOLD, 12));
    ...
    public void mouseExited(MouseEvent e) {
        ...
        if (e.getComponent() != getComponent()) {
            e.getComponent().setFont(new FontUIResource("sanserif", Font.PLAIN, 12));
