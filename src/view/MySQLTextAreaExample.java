...
public class MySQLTextAreaExample extends JTextArea {
    ...
    private void executeQuery(String query, ConnectingToolsModel toolsModel, MySQLConnection connection) {
        try {
    ...
    private void executeUpdate(String query, ConnectingToolsModel toolsModel, MySQLConnection connection) {
        try {
            Connection conn = connection.getCon(toolsModel);
