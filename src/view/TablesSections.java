...
public class TablesSections {
	...
	public void saisie() throws NullPointerException {
		...
		createTableAcces(createbtn, createField);
	...
	void createTableAcces(JButton button, JTextField field) {
		...
		field.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				if (n.length() > 0) {
					if (listNames != null) {
						if (EddoLibrary.numbers().contains(n.substring(0, 1)) || listNames.contains(n.toUpperCase())
								|| n.contains(" ")) {
